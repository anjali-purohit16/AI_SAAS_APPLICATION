...
const RemoveObject = () => {
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 bg-linear-to-br  from-red-900 to-black text-white'>
        ...
        <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-black rounded-lg border border-gray-200'>
            ...
            <p className='mt-6 text-lg font-medium'>Upload image</p>
            ...
            <p className='mt-6 text-xl font-medium'>Describe object name to remove</p>
            ...
            <button disabled={loading} className='w-full flex justify-center items-center active:scale-75 gap-2 bg-linear-to-r from-[#417DF6] to-[#8E37EB] text-white px-4 py-2 mt-6 text-lg rounded-lg cursor-pointer'>
                {
...

            {
                !content ? (<div className='flex-1 flex justify-center items-center'>
                                <div className='text-sm flex flex-col items-center gap-5 text-gray-400'>
                                    ...
                                    <p className='text-lg font-semibold'>Upload an image and click "Remove Object" to get started</p>
                                </div>
                            </div>) : (
